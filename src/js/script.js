...
const guitar = {
  guitarBrand: 'Gibson',
  guitarType: 'Les Paul Standard 50s',
};
// функция ничего не делает, просто возвращает
const getGuitarName = function () {
  return `${this.guitarBrand} ${this.guitarType}`;
};
...
// байндим контекст функции getGuitarName, на ее базе получить новую функцию
const bindedGuitarName = bind(getGuitarName, guitar);
console.log(bindedGuitarName);
console.log(bindedGuitarName());
